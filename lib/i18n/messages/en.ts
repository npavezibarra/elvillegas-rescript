...
export const en = {
  ...
  "youtube.import": "Import Video",
  "youtube.importing": "Importing...",
  "youtube.cancel": "Cancel",
  "youtube.help": "Uses bundled yt-dlp when available, otherwise the local system install.",
  "youtube.starting": "Starting import...",
  "youtube.importingVideo": "Importing video...",
  "youtube.invalidUrl": "Enter a valid video URL.",
  "youtube.desktopOnly": "YouTube import is only available in the desktop app.",
  "youtube.failed": "Could not import the YouTube video.",
  ...
  "transcript.pause": "Pause {duration}",
  "transcript.pauseMenu": "Pause options",
  "transcript.removePause": "Remove pause",
  "transcript.removeAllPauses": "Remove all pauses",
  ...
  "timeline.scrollZoom": "Pinch to zoom in/out",
  ...
  "export.finalizing": "Finalizing the file…",
  ...
  "progress.youtubeReadingDetails": "Reading video details...",
  "progress.youtubeDetailsReady": "Video details ready...",
  "progress.youtubeStartingBundled": "Starting bundled yt-dlp...",
  "progress.youtubeStarting": "Starting yt-dlp...",
  "progress.youtubeDownloading": "Downloading video...",
  "progress.youtubePreparing": "Preparing media...",
  "progress.youtubeLoading": "Loading media into Rescript...",
  ...
  "error.exportStalled":
    "The media engine stopped responding. Try exporting again; a fresh engine will be used.",
